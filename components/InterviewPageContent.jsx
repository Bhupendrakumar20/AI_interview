...
export default function InterviewPageContent({
  ...
  return (
    <div className="flex flex-col gap-10">
        ...
        <div className="relative flex items-center justify-between">
          <div>
            ...
            <Link
              ...
              className="inline-flex items-center gap-2 px-6 py-2.5 bg-gradient-to-r from-blue-500 to-blue-600 hover:from-blue-400 hover:to-blue-500 text-white rounded-lg font-medium transition-all duration-200 transform hover:-translate-y-0.5 hover:shadow-lg hover:shadow-blue-500/30"
            >
              Try Interview Buddy
            </Link>
          </div>
      ...
      {/* Resume Round Mode */}
      {activeMode === "resume-round" && <ResumeRound />}
      ...
      <section className="flex flex-col gap-4 mt-2 animate-fadeInUp">
        <div className="flex flex-row items-center justify-between gap-2">
          ...
          {hasPastInterviews && (
            <Link
              href="/"
              className="px-4 py-2 bg-slate-800/50 border border-slate-700/50 rounded-lg text-sm font-medium text-slate-300 hover:bg-slate-700/50 transition-all duration-200"
            >
              Back to Dashboard
            </Link>
          )}
