...
export const FALLBACK_MOCK_TEST_QUESTIONS = {
  Technical: [
    ...
    {
      question: "What is the difference between a clustered index and a non-clustered index in a database?",
      expectedAnswer: "A clustered index defines the physical order of rows in the table. A non-clustered index is stored in one place and physical data is stored in another, with a pointer to the physical data.",
      tips: [
        "Mention that a table can have only one clustered index",
        "Explain index scan vs index seek performance",
        "Discuss storage overhead of non-clustered indexes"
      ],
      difficulty: "Medium"
    }
  ],
  Behavioral: [
    {
      question: "Tell me about a time you had a serious conflict with a team member. How did you resolve it?",
      expectedAnswer: "Explain using the STAR method: Situation, Task, Action, Result. Highlight active listening, finding common ground, and focusing on project success rather than personal differences.",
      tips: [
        "Do not blame or speak negatively about the team member",
        "Emphasize your communication and compromise strategy",
        "Conclude with a positive learning or outcome"
      ],
      difficulty: "Medium"
    },
    {
      question: "Describe a situation where you had to work under tight deadlines and prioritize tasks.",
      expectedAnswer: "Detail how you evaluated tasks based on impact and effort, communicated with stakeholders to manage expectations, and executed efficiently to meet the critical requirements.",
      tips: [
        "Showcase prioritization frameworks (e.g. Eisenhower Matrix)",
        "Highlight your focus and stress management",
        "Mention the result and how it helped the team/client"
      ],
      difficulty: "Medium"
    }
  ],
  "System Design": [
    ...
    },
    {
      ...
      expectedAnswer: "Use a base-62 encoding on unique sequence numbers. Store mappings in a distributed key-value store. Implement caching for popular URLs and scale with load balancers.",
      tips: [
        "Explain the hash generation options (MD5 vs Counter)",
        "Estimate read/write QPS and storage requirements",
        "Detail redirection redirect status codes (301 vs 302)"
      ],
      difficulty: "Medium"
    }
  ],
  "Coding Challenge": [
    ...
    },
    {
      ...
      expectedAnswer: "Use a stack to push matching opening brackets, and pop to verify correctness when a closing bracket is encountered. Ensure the stack is empty at the end.",
      tips: [
        "Explain stack LIFO behavior",
        "Check for early exits if string length is odd",
        "Handle unmatched opening or closing brackets"
      ],
      difficulty: "Easy"
    }
  ]
