 ...
 * @param {Object} params - { question, userAnswer, expectedKeywords }
 * @returns {Promise<Object>} - Keyword match result
 */
export async function phase1KeywordMatching(params) {
  const { question, userAnswer, expectedKeywords } = params;
 ...
 * @param {Object} params - { question, userAnswer, questionDifficulty }
 * @returns {Promise<Object>} - Contextual reasoning result
 */
export async function phase3ContextualReasoning(params) {
  const { question, userAnswer, questionDifficulty } = params;
 ...
 * @param {Object} params - { question, userAnswer, expectedKeywords, skillLevel, questionDifficulty }
